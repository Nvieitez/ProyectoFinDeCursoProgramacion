...
// IMPORTS ------------------------------------------------------------------------------------------------------------------------------------------
    ...
    // Primero vamos a importar la librería "SQL", esta nos va a permitir conectarnos a la base de datos de nuestro programa.
    import java.sql.*;
    ...
    public void MétodoConexiónBaseDeDatosLibre() {
        ...
        try {
            ...
            connection = DriverManager.getConnection(
                ...
                "jdbc:postgresql://localhost:1987/postgres", "postgres", "1987"
