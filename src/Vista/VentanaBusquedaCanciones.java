...
public class VentanaBusquedaCanciones {
...
// IMAGEN VENTANA BÚSQUEDA --------------------------------------------------------------------------------------------------------------------------
                ...
                // Primero declaramos la imagen que vayamos a importar.
                ImageIcon imagenVentanaBusqueda = new ImageIcon(Controlador.Controller.metodoImagenBusquedaCancion());
...
// TEXTO VENTANA BÚSQUEDA ---------------------------------------------------------------------------------------------------------------------------
                ...
                // Título
                if (Controlador.Controller.metodoImagenBusquedaCancion() == "src/Recursos/Imágenes/PlaceHolder.png"){
                ...
                textVentanaBusqueda.setText(ListaCanciones.EnviarCancionBuscada() + "\n\n" + "Pertenece al disco: " + Controlador.Controller.metodoDiscoBusquedaCancion() + "\n\n" + "Está compuesta por: " + Controlador.Controller.metodoNombreArtistaBusquedaCancion());
...
// TEXTO COMPRA EL VINILO ---------------------------------------------------------------------------------------------------------------------------
                ...
                // Primero declaramos la imagen que vayamos a importar.
                ImageIcon TextoAñadeCarrito = new ImageIcon("src/Recursos/Imágenes/TextoBuscaEsteVinilo.png");
