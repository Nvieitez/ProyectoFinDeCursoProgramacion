...
public class InicioSesion {
        ...
        static String usuarioBuscado;
        static String contrasenaBuscada;
...
// CREAR CUENTA INICIO SESIÓN -----------------------------------------------------------------------------------------------------------------------
                ...
                // Localización del Jlabel
                labelCrearCuenta.setBounds(280, 400, 400, 100);
...
// CAMPO DE TEXTO USUARIO ---------------------------------------------------------------------------------------------------------------------------
                ...
                // Color
                textUsuario.setCaretColor(Color.RED);
...
// CAMPO DE TEXTO CONTRASEÑA ------------------------------------------------------------------------------------------------------------------------
                ...
                // Color
                textContrasena.setCaretColor(Color.RED);
...
// BOTÓN INICIAR SESIÓN -----------------------------------------------------------------------------------------------------------------------------
                ...
                // Tamaño y localización
                botonAcceder.setBounds(290, 250, 400, 40);
                ...
                botonAcceder.addMouseListener(new MouseAdapter() {
                        ...
                        public void mouseClicked(MouseEvent AccionBotonAcceder) {
                                ...
                                // Aquí se llamará al método "Registro" para que se abra la ventana de registro.
                                usuarioBuscado = textUsuario.getText();
                                contrasenaBuscada = textContrasena.getText();
                                Controlador.Controller.metodoInicioUsuario();
