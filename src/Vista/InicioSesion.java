...
// CONTRASEÑA INICIO SESIÓN -------------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenContraseña = new ImageIcon("src/Recursos/Imágenes/TextoContraseña.png");
...
// BÚSQUEDA INICIO SESIÓN ------------------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenBúsqueda = new ImageIcon("src/Recursos/Imágenes/TextoBuscarVinilos.png");
...
// TEXTO CANCIÓN INICIO SESIÓN ---------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon TextoCanción = new ImageIcon("src/Recursos/Imágenes/TextoCanciones.png");
