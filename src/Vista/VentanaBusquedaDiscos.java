...
public class VentanaBusquedaDiscos {
...
// IMAGEN VENTANA BÚSQUEDA --------------------------------------------------------------------------------------------------------------------------
                ...
                // Primero declaramos la imagen que vayamos a importar.
                ImageIcon imagenVentanaBusqueda = new ImageIcon(Controlador.Controller.metodoImagenBusquedaDisco());
...
// TEXTO VENTANA BÚSQUEDA ---------------------------------------------------------------------------------------------------------------------------
                ...
                // Título
                if (Controlador.Controller.metodoImagenBusquedaDisco() == "src/Recursos/Imágenes/PlaceHolder.png"){
                        ...
                        textVentanaBusqueda.setText(Controlador.Controller.metodoTextoBusquedaDisco() + "\n\n" + "Precio : " + Controlador.Controller.metodoPrecioBusquedaDisco() + " €");
                };
...
// TEXTO COMPRA EL VINILO ---------------------------------------------------------------------------------------------------------------------------
                ...
                // Primero declaramos la imagen que vayamos a importar.
                ImageIcon TextoAñadeCarrito = new ImageIcon("src/Recursos/Imágenes/TextoAñadirAlCarrito.png");
                ...
                labelTextoAñadirAlCarrito.addMouseListener(new MouseAdapter() {
                        ...
                        public void mouseClicked(MouseEvent AccionLabelTextoAñadirAlCarrito) {
                                ...
                                if (Controlador.Controller.metodoImagenBusquedaDisco() == "src/Recursos/Imágenes/PlaceHolder.png"){
                                        ...
                                        JOptionPane.showMessageDialog(null, "El disco que intentas comprar no existe");
                                }
                                else{
