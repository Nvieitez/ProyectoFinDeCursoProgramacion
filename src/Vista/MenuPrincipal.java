...
// COMIENZO DEL CÓDIGO ------------------------------------------------------------------------------------------------------------------------------
    ...
    /**
     * "MétodoMenúPrincipal" se encarga de crear el entorno gráfico del menú principal.
     *
...
// FONDO MENÚ PRINCIPAL -----------------------------------------------------------------------------------------------------------------------------
        ...
        // Editamos la imagen.
        Image nuevaImagenFondoMenuPrincipal = imagenFondoMenuPrincipalTemporal.getScaledInstance(800, 600, Image.SCALE_SMOOTH);
...
// TEXTO MENÚ PRINCIPAL -----------------------------------------------------------------------------------------------------------------------------
        ...
        // Editamos la imagen.
        Image nuevaImagenTextoMenuPrincipal = imagenTextoMenuPrincipalTemporal.getScaledInstance(600, 300, Image.SCALE_SMOOTH);
...
// BÚSQUEDA MENÚ PRINCIPAL ------------------------------------------------------------------------------------------------------------------------------
        ...
        // Editamos la imagen.
        Image nuevaImagenBusquedaMenuPrincipal = imagenBusquedaTemporal.getScaledInstance(200, 50, Image.SCALE_SMOOTH);
...
// TEXTO ARTISTA MENÚ PRINCIPAL ---------------------------------------------------------------------------------------------------------------------
        ...
        // Editamos la imagen.
        Image nuevoTextoArtistaMenuPrincipal = textoArtistaTemporal.getScaledInstance(40, 100, Image.SCALE_SMOOTH);
...
// TEXTO CANCIÓN MENÚ PRINCIPAL ---------------------------------------------------------------------------------------------------------------------
        ...
        // Editamos la imagen.
        Image nuevoTextoCancionMenuPrincipal = textoCancionTemporal.getScaledInstance(40, 100, Image.SCALE_SMOOTH);
...
// TEXTO INICIO SESIÓN ------------------------------------------------------------------------------------------------------------------------------
        ...
        // Editamos la imagen.
        Image nuevoTextoIniciarSesion = textoIniciarSesionTemporal.getScaledInstance(150, 50, Image.SCALE_SMOOTH);
