...
// TABLA DE COMPRAS ---------------------------------------------------------------------------------------------------------------------------------
                ...
                tablaCompras.setModel(new DefaultTableModel(
                                new Object[][] {
                                                ...
                                                { "DeadMau5", "Album Title Goes Here", "40"},
                                                { "Hironobu Kageyama", "DBZ The Best Selection", "50"},
                                                {"Michael Jackson", "Bad", "60"}
...
// BOTÓN COMPRAR ------------------------------------------------------------------------------------------------------------------------------------
                ...
                botonComprar.setBounds(420, 440, 120, 35);
                ...
                @Override
                public void actionPerformed(ActionEvent AcciónBotónComprar){
                                
                        if(Controlador.Controller.getComprobanteInicioSesion() == false){

                                JOptionPane.showMessageDialog(null, "Tienes que iniciar sesión primero para poder comprar");
                        }
                        else
