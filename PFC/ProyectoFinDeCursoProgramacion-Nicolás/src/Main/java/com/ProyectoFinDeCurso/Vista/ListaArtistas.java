...
// TEXTO BUSCAR DISCO FAVORITO ----------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon TextoBuscarArtistaFavorito = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoArtistaFavorito.png");
...
// TEXTO DISCOS DEL MOMENTO -------------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon TextoArtistasDelMomento = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoArtistasDelMomento.png");
...
// IMAGEN DISCOS DEL MOMENTO 1 -----------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenArtistaDelMomento1 = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/PLACEHOLDER (ELIMINAR)/A.png");
...
// IMAGEN DISCOS DEL MOMENTO 2 -----------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenArtistaDelMomento2 = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/PLACEHOLDER (ELIMINAR)/A.png");
...
// IMAGEN DISCOS DEL MOMENTO 3 -----------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenArtistaDelMomento3 = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/PLACEHOLDER (ELIMINAR)/A.png");
