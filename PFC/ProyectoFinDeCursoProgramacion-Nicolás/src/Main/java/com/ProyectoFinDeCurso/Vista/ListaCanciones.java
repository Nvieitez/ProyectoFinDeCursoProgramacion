...
// TEXTO BUSCAR CANCIÓN FAVORITA --------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon TextoBuscarCanciónFavorita = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoCanciónFavorita.png");
...
// TEXTO CANCIONES DEL MOMENTO ----------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon TextoCancionesDelMomento = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoCancionesDelMomento.png");
...
// IMAGEN CANCIONES DEL MOMENTO 1 -----------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenCanciónDelMomento1 = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/PLACEHOLDER (ELIMINAR)/A.png");
...
// IMAGEN CANCIONES DEL MOMENTO 2 -----------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenCanciónDelMomento2 = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/PLACEHOLDER (ELIMINAR)/A.png");
...
// IMAGEN CANCIONES DEL MOMENTO 3 -----------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenCanciónDelMomento3 = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/PLACEHOLDER (ELIMINAR)/A.png");
