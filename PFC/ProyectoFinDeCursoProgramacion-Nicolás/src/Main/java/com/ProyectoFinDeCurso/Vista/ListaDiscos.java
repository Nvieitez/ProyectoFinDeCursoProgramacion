...
// CLASE LISTA DISCOS ----------------------------------------------------------------------------------------------------------------------------
    ...
    public class ListaDiscos {
        ...
        public static void MétodoListaDiscos(){
...
// TEXTO LOGO ---------------------------------------------------------------------------------------------------------------------------------------
        ...
        ImageIcon ImagenLogo = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoLogo.png");
...
// TEXTO BUSCAR VINILOS -----------------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenBuscarVinilos = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoBuscarVinilos.png");
...
// TEXTO ARTISTAS -----------------------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenArtistas = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoArtistas.png");
...
// TEXTO DISCOS -------------------------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenDiscos = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoDiscos.png");
...
// TEXTO CANCIONES ----------------------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenCanciones = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoCanciones.png");
...
// IMAGEN BUSCAR POR DISCOS -------------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenBuscarPorDiscos = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/ImagenBuscarPorDisco.jpg");
...
// IMAGEN BUSCAR POR CANCIONES ----------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenBuscarPorCanciones = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/ImagenBuscarPorCanción.jpg");
...
// TEXTO BUSCAR DISCO FAVORITO ----------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon TextoBuscarDiscoFavorito = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoDiscoFavorito.png");

        // Ahora la incluimos en una variable temporal para poder modificarla.
        Image TextoBuscarDiscoFavoritoTemporal = TextoBuscarDiscoFavorito.getImage(); 

        // Editamos la imagen.
        Image NuevoTextoBuscarDiscoFavorito = TextoBuscarDiscoFavoritoTemporal.getScaledInstance(400, 90, java.awt.Image.SCALE_SMOOTH);
...
// TEXTO DISCOS DEL MOMENTO -------------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon TextoDiscosDelMomento = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoDiscosDelMomento.png");

        // Ahora la incluimos en una variable temporal para poder modificarla.
        Image TextoDiscosDelMomentoTemporal = TextoDiscosDelMomento.getImage(); 

        // Editamos la imagen.
        Image NuevoTextoDiscosDelMomento = TextoDiscosDelMomentoTemporal.getScaledInstance(400, 90, java.awt.Image.SCALE_SMOOTH);
...
// BOTÓN BUSCAR LISTA DISCOS ------------------------------------------------------------------------------------------------------------------------
        ...
        PanelListaDiscos1.add(BotónBuscar);

// IMAGEN DISCOS DEL MOMENTO 1 -----------------------------------------------------------------------------------------------------------------------

        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenDiscoDelMomento1 = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/PLACEHOLDER (ELIMINAR)/A.png");

        // Ahora la incluimos en una variable temporal para poder modificarla.
        Image ImagenDiscoDelMomento1Temporal = ImagenDiscoDelMomento1.getImage(); 

        // Editamos la imagen.
        Image NuevaImagenDiscoDelMomento1 = ImagenDiscoDelMomento1Temporal.getScaledInstance(170, 170, java.awt.Image.SCALE_SMOOTH);
...
// IMAGEN DISCOS DEL MOMENTO 2 -----------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenDiscoDelMomento2 = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/PLACEHOLDER (ELIMINAR)/A.png");

        // Ahora la incluimos en una variable temporal para poder modificarla.
        Image ImagenDiscoDelMomento2Temporal = ImagenDiscoDelMomento2.getImage(); 

        // Editamos la imagen.
        Image NuevaImagenDiscoDelMomento2 = ImagenDiscoDelMomento2Temporal.getScaledInstance(170, 170, java.awt.Image.SCALE_SMOOTH);
...
// IMAGEN DISCOS DEL MOMENTO 3 -----------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenDiscoDelMomento3 = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/PLACEHOLDER (ELIMINAR)/A.png");

        // Ahora la incluimos en una variable temporal para poder modificarla.
        Image ImagenDiscoDelMomento3Temporal = ImagenDiscoDelMomento3.getImage(); 

        // Editamos la imagen.
        Image NuevaImagenDiscoDelMomento3 = ImagenDiscoDelMomento3Temporal.getScaledInstance(170, 170, java.awt.Image.SCALE_SMOOTH);
