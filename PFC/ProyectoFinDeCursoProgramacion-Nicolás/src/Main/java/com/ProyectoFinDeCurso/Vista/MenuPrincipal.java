...
// FONDO MENÚ PRINCIPAL -----------------------------------------------------------------------------------------------------------------------------
        ...
        ImageIcon ImagenFondoMenúPrincipal = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/ImagenFondo.jpg");
...
// TEXTO MENÚ PRINCIPAL -----------------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenTextoMenúPrincipal = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoMenúPrincipal.png");
...
// LOGO MENÚ PRINCIPAL ------------------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon LogoMenúPrincipal = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoLogo.png");
...
// BÚSQUEDA MENÚ PRINCIPAL ------------------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon ImagenBúsquedaMenúPrincipal = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoBuscarVinilos.png");
...
// TEXTO ARTISTA MENÚ PRINCIPAL ---------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon TextoArtistaMenúPrincipal = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoArtistas.png");
...
// TEXTO DISCO MENÚ PRINCIPAL -----------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon TextoDiscoMenúPrincipal = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoDiscos.png");
...
// TEXTO CANCIÓN MENÚ PRINCIPAL ---------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon TextoCanciónMenúPrincipal = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoCanciones.png");
...
// TEXTO INICIO SESIÓN ------------------------------------------------------------------------------------------------------------------------------
        ...
        // Primero declaramos la imagen que vayamos a importar.
        ImageIcon TextoIniciarSesión = new ImageIcon("ProyectoFinDeCursoProgramacion-Nicolás/src/Recursos/Imágenes/TextoIniciarSesión.png");
        ...
        LabelTextoIniciarSesión.addMouseListener(new java.awt.event.MouseAdapter() {
                ...
                public void mouseClicked(java.awt.event.MouseEvent AcciónLabelTextoIniciarSesión){
                        ...
                        // Dentro del mouseClicked vamos a determinar que debe de hacer la imagen.
                        InicioSesion.MétodoInicioSesión();
